...
from app.server import LocalImagesServer
...
local_images_server = LocalImagesServer()


@app.route("/", methods=['GET'])
def home():
    data = data_manager.get_full_page_data()
...
def filter_images_by_tags():
    ...
    data_manager.filter_by_tags(selected_tags)
    return redirect(url_for('home'))
